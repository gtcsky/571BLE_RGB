...
//			color.cw = ((uint32)(table_temperature[light.colorTemperature-32][0]) * (uint32)(light.brightness*80/100*94+600) )/10000;
//			color.mw = ((uint32)(table_temperature[light.colorTemperature-32][1]) * (uint32)(light.brightness*80/100*94+600) )/10000;
//			color.red = 0;
//			color.green = 0;
//			color.blue = 0;
//
...
//		LOG("_\n MODE_EFFE \n_");
		...
		color.green = 0;
		color.blue = 0;
//		displayParams.arrowIndex = PreinstallEffect;
		displayParams.backupArrowIndex=displayParams.arrowIndex;
