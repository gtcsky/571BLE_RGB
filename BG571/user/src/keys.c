...
void keys_Init(void)
{
	...
	//KEY_POWER
	gpio_struct[0].pin = GPIO_KEY_POWER;
	...
	//KEY_LIGHT_UP
	gpio_struct[1].pin = GPIO_KEY_LIGHT_UP;
	...
	//KEY_LIGHT_DOWN
	gpio_struct[2].pin = GPIO_KEY_LIGHT_DOWN;
	...
	//KEY_FUNC_UP
	gpio_struct[3].pin = GPIO_KEY_FUNC_UP;
	...
	//KEY_FUNC_DOWN
	gpio_struct[4].pin = GPIO_KEY_FUNC_DOWN;
	...
	//GPIO_CHARGE_DET
	gpio_struct[5].pin = GPIO_CHARGE_DET;
	gpio_struct[5].ioe = IE;
	gpio_struct[5].bit_action = Bit_DISABLE;
	gpio_struct[5].pull_type = WEAK_PULL_UP;
	...
	//GPIO_CHARGE_FULL
	gpio_struct[6].pin = GPIO_CHARGE_FULL;
	gpio_struct[6].ioe = IE;
	gpio_struct[6].bit_action = Bit_DISABLE;
	gpio_struct[6].pull_type = PULL_DOWN;
	//gpio_struct[6].pull_type = FLOATING;
	gpio_struct[6].wakeup_pol = NEGEDGE;
	gpio_struct[6].wakeup_t.posedgeHdl = NULL;
	gpio_struct[6].wakeup_t.negedgeHdl = NULL;
//	gpio_struct[6].wakeup_t.posedgeHdl = posedge_callback_wakeup;
//	gpio_struct[6].wakeup_t.negedgeHdl = negedge_callback_wakeup;
