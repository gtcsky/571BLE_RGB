...
static const uint8 defaultModelNumber[] = {"BG571"};
...
static const uint8 defaultFirmwareVersion[] = {"21102701"};
static const uint8 defaultHardwareVersion[] = {"BG334.00"};
static const uint8 defaultSoftwareVersion[] = {"571T2.10"};
...
static const uint8 defaultUserManualInfo[]={"BG571A001B001C001"};
uint8 UserManualInfo[SYSPARAM_MAX_USER_MANUAL_SIZE+2]={0};
static const uint8 defaultOtaFile[]={"BG571D001E001F001"};
