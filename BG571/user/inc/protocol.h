...
#define	BATT_LV3_THESHOLD							3800	//3.7
#define	BATT_LV4_THESHOLD							3970	//4.05
...
#define GPIO_DISPLAY_RST							P32//P3
#define GPIO_DISPLAY_DC							P33//P4
#define GPIO_DISPLAY_CS								P31//P2
#define GPIO_DISPLAY_CLK							P34//P5
#define GPIO_DISPLAY_MISO							GPIO_DUMMY
#define GPIO_DISPLAY_MOSI							P0//P6

#define GPIO_KEY_POWER								P6
#define GPIO_KEY_LIGHT_UP							P3//PGPIO_DUMMY//P14
#define GPIO_KEY_LIGHT_DOWN						P2//GPIO_DUMMY//P13
#define GPIO_KEY_FUNC_UP							P5
...
#define GPIO_LIGHT_POWER							P26
#define GPIO_LIGHT_EN								P27
#define GPIO_LIGHT_CW								P25
#define GPIO_LIGHT_MW								P24
#define GPIO_LIGHT_RED								P23
#define GPIO_LIGHT_GREEN							P22
#define GPIO_LIGHT_BLUE								P21
