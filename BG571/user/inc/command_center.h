...
#define	BATTERY_RESISTANCE				0.110		//(3.90-3.68)/1.85	for charging with protected board
...
#define 	RED_POWER_RATING					5.17// =4.01*1.29
#define 	GREEN_POWER_RATING				5.89	//=3.98*1.48
#define 	BLUE_POWER_RATING				6.00// =3.97*1.51
#define	CW_POWER_RATING					9.53	//10.04=8.96/MAX_CW_DUTY    8.96=4.15*2.16		(2.21*3.88=8.57  BG571)
#define	MAX_CW_DUTY						(0.94/1.0)
#define	MW_POWER_RATING					9.53	//10.05=8.96/MAX_CW_DUTY       8.96=4.15*2.16		(2.18*3.88=8.45  BG571)
#define	MAX_MW_DUTY						(0.94/1.0)

#define	MAX_CHARGE_CURRENT				2.0					//2.0A
#define	KEEP_VOLT_THRESHOLD				4.35				//4.00V
...
#define	CHRAGE_FULL_VOLT					4.40//(BATT_VOLTAGE_MAX*0.001)//4.30
